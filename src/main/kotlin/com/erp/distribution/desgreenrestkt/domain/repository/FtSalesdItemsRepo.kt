...
interface FtSalesdItemsRepo {
    ...
    fun findAllByDivision(fdivisionBean: Int): List<FtSalesdItemsEntity>
    fun findAllByDivisionAndShareToCompany(fdivisionBean: Int, fcompanyBean: Int): List<FtSalesdItemsEntity>
