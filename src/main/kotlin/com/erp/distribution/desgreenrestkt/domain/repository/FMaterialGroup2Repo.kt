...
interface FMaterialGroup2Repo {
    ...
    fun findAllByDivision(fdivisionBean: Int): List<FMaterialGroup2Entity>
    fun findAllByDivisionAndShareToCompany(fdivisionBean: Int, fcompanyBean: Int): List<FMaterialGroup2Entity>
